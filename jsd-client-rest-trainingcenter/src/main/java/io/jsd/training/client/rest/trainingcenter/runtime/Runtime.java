...
public class Runtime {
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, ClientProtocolException, IOException {
...
//		Stagiaire stagiaireDelete = mapper.readValue(sendDeleteRequest(), Stagiaire.class);
		sendDeleteRequest();
	...
	public static String sendGetRequest() throws ClientProtocolException, IOException {
		...
		HttpGet httpGet = new HttpGet(
				"http://localhost:8080/CentreFormation/rest/stagiaire/id/3");
...
//				new InputStreamReader(response.getEntity().getContent()));
		...
		LineIterator iterator = new LineIterator(new InputStreamReader(response
	...
	public static String sendPostRequest() throws ClientProtocolException, IOException {
		...
		HttpPost httpPost = new HttpPost(
				"http://localhost:8080/CentreFormation/rest/stagiaire");
...
//				new InputStreamReader(response.getEntity().getContent()));
	...
	public static void sendDeleteRequest() throws ClientProtocolException, IOException {
		...
		HttpDelete httpDelete = new HttpDelete(
				"http://localhost:8080/CentreFormation/rest/stagiaire/id/5");
