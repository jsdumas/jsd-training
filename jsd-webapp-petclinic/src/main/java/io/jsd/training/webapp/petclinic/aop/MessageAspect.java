package io.jsd.training.webapp.petclinic.aop;
...
public class MessageAspect {
	...
	public void afterServiceCreate(Object mResult) throws ServiceException {
		...
		if (mResult instanceof Animal) {
			...
			logger.info("Création d'un animal de type "
					+ animal.getClass().getSimpleName());
			message.setType("Création  d'un animal de type "
					+ animal.getClass().getSimpleName());
			...
			message.setType("Création d'un "
					+ proprietaire.getClass().getSimpleName());
	...
	public void afterServiceRemove(JoinPoint joinpoint) throws ServiceException {
		...
		if (mResult[0] instanceof Animal) {
			...
			message.setType("Suppression de " + animal.getNom() + " de type "
					+ animal.getClass().getSimpleName());
			...
			message.setType("Suppression d'un "
					+ proprietaire.getClass().getSimpleName());
	...
	public void afterServiceUpdate(Object result) throws ServiceException {
		...
		if (result instanceof Animal) {
			...
			message.setType("Mise à jour de " + animal.getNom() + " de type "
					+ animal.getClass().getSimpleName());
			message.setMessage(animal.getClass().getSimpleName()
					+ " mis à jour");
			messageService.save(message);
			...
			message.setType("Mise à jour d'un "
					+ proprietaire.getClass().getSimpleName());
