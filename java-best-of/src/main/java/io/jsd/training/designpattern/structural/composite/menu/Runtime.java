...
import io.jsd.training.designpattern.structural.composite.menu.pattern.Menu;
import io.jsd.training.designpattern.structural.composite.menu.pattern.MenuComponent;
import io.jsd.training.designpattern.structural.composite.menu.pattern.MenuItem;

public class Runtime {
	public static void main(String args[]) {

		// Create pancakeHouseMenu + add items
		...
		// Create dinerMenu + add items + add dessertMenu to dinerMenu
		...
		// Create cafeMenu + add items + add coffeMenu to cafeMenu
		...
		// General menu declaration + add other menu to allMenus
		MenuComponent allMenus = new Menu("ALL MENUS", "All menus combined");
		// Add menu to general menu
		allMenus.add(pancakeHouseMenu);
		allMenus.add(dinerMenu);
		allMenus.add(cafeMenu);

		// Add allmenu to waitress
