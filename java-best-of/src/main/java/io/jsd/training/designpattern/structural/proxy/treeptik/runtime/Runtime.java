package io.jsd.training.designpattern.structural.proxy.treeptik.runtime;

import java.util.Iterator;
import java.util.List;

import io.jsd.training.designpattern.structural.proxy.treeptik.proxy.FileDescription;
