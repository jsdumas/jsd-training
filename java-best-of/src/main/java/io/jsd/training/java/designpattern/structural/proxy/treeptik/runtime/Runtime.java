package io.jsd.training.java.designpattern.structural.proxy.treeptik.runtime;

import java.util.Iterator;
import java.util.List;

import io.jsd.training.java.designpattern.structural.proxy.treeptik.proxy.FileDescription;
