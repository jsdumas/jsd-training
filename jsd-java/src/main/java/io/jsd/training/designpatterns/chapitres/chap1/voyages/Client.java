...
public class Client {
    public static void main(String[] args) {
        ...
        Voyage voyage;
        System.out
                .print("Quelle gamme de voyage désirez vous composer? "
                        + "Voyage de luxe (1) ou Voyage economique (2) :");
        ...
        System.out
                .print("Désirez-vous inclure les vols? "
                        + "Oui (1) ou Non (2) :");
        choix = reader.next();
        if (choix.equals("1")) {
        ...
        System.out
                .print("Désirez-vous inclure l'hebergement dans un hotel? "
                        + "Oui (1) ou Non (2) :");
        choix = reader.next();
        if (choix.equals("1")) {
        ...
        System.out
                .print("Désirez-vous inclure les repas? "
                        + "Oui (1) ou Non (2) :");
        choix = reader.next();
        if (choix.equals("1")) {
        ...
        System.out
                .print("Désirez-vous inclure des activités? "
                        + "Oui (1) ou Non (2) :");
        choix = reader.next();
        if (choix.equals("1")) {
